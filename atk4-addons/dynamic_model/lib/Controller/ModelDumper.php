...
/**
 * This class will read your model structure one model at a time and will store
 * the data inside a PHP file. Unlike database dump, this model relies on models
 * only and therefore would work across any  Data source.
 */
class Controller_ModelDumper extends \AbstractController
{
    ...
    {
        if ($this->models_backed_up[get_class($model)]++) {
            return true;
        }
